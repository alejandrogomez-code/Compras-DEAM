...
3. Pegá y ejecutá, en este orden:
   ...
   - `sql/007_import_demos.sql` — importa los 177 registros de Demo (42 clientes, 130 materiales únicos) desde la hoja "Demos" del Excel, replicando la fórmula `SUMIF` que "Con disponibles" usaba para calcular "En Demo". No da de alta productos nuevos porque los 130 materiales ya existían (equipos originales o repuestos importados en el paso 005).
...
- **Demo**: listado propio con los 177 registros reales (cliente, cantidad, estado, fecha de salida, retorno estimado), igual que No Conforme y Cuarentena. Clic en una fila abre el detalle para editar cliente, estado (en_demo/devuelto/vendido), retorno estimado y observaciones. Tiene su propio Exportar/Plantilla/Importar Excel.
- **No Conforme y Cuarentena**: listados propios con todos los registros reales (137 y 50, importados desde la hoja QC & NC del Excel). Cada fila se puede abrir para editar estado, motivo/resolución u origen/resultado de verificación. Los productos que no existían como equipo (repuestos y accesorios) se dieron de alta marcados con la categoría "Repuesto/accesorio", y sus cantidades impactan igual en "No disponible" y "Disponible" del Monitor general.
